...
from app.agent.wechat_publish import WechatPublish
...
# ── ObservableWechatPublish ────────────────────────────


class ObservableWechatPublish(WechatPublish):
    """WechatPublish 的事件注入子类。

    与 ObservableManus / ObservableDataAnalysis / ObservableQuickQuery 完全相同的 emit 逻辑。
    """
...
async def create_observable_agent(
    ...
    host_workspace: str = "",
) -> Manus | DataAnalysis | QuickQuery | WechatPublish:
